...
class Planificaciones(db.Model):
    ...
    id_profesor = db.Column(db.Integer, db.ForeignKey("profesores.id_usuario"), nullable=False)
    id_alumno = db.Column(db.Integer, db.ForeignKey("alumnos.id_usuario"), nullable=False)
